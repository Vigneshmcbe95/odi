...
-- Scratch-Schema Datenladen: SSC41LL_FST
-- Quelle: SCR_ALL_FST (Basisschema, nicht der 43er-Sandbox-Peer)
...
v_source_user varchar(30) := 'SCR_ALL_FST';
v_target_user varchar(30) := 'SSC41LL_FST';
