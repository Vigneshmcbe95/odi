-- 1) Rein lesend: wo existiert W334_WRK_PERSB_TN bereits?
SELECT owner, table_name
FROM dba_tables
WHERE table_name = 'W334_WRK_PERSB_TN'
ORDER BY owner;

-- 2) Struktur aus der gefundenen Quelle klonen (Owner aus Abfrage 1
--    unten eintragen -- vermutlich ein SSC41-Pendant wie SSC43WH_FST).
declare
v_source_owner varchar2(30) := '<QUELLE_HIER_EINTRAGEN>';  -- z.B. 'SSC43WH_FST'
v_target_owner varchar2(30) := 'SSC41WH_FST';
v_table_name   varchar2(30) := 'W334_WRK_PERSB_TN';
