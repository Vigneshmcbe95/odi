...
-- Scratch-Schema Datenladen: SSC41M_STAT_FST
-- Quelle: SCR_DM_STAT_FST (Basisschema, nicht der 43er-Sandbox-Peer)
...
v_source_user varchar(30) := 'SCR_DM_STAT_FST';
v_target_user varchar(30) := 'SSC41M_STAT_FST';
