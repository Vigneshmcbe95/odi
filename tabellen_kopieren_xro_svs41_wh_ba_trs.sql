...
v_source_user varchar(20) := 'THM_DWH_BA_TRS';
v_target_user varchar(20) := 'SVS41WH_BA_TRS';
  ...
  for c in (
         select t.owner source_owner
          ...
          where t.owner = v_source_user
                ...
                and (t.table_name like 'T%_DWH_BETRIEB'
                 or  t.table_name like 'TD_DWH_TRAEGER%'
                 or  t.table_name like 'TH_DWH_TRAEGER%'
                 or  t.table_name like 'TH_DWH_MASSNAHME%'
                 or  t.table_name like 'TE_FST_AMDL_KURSNET_TRS%'
                 or  t.table_name like 'TH_DWH_COLIBRI_WBK_TRS%')
